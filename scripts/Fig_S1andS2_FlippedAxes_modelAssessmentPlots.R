...
#all 
plot(MPMEstimates ~ STBIOMSha, data = data.mod, xlim = c(0,625), ylim = c(0,625), col = 'white', las=1, xaxt="n")#, main = 'a)')
...
points(MPMEstimates ~ STBIOMSha, data = data.mod, pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val, pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val), col = trendCol, lwd = trendlwd, lty = trendlwd)
mtext("Predicted AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
...
# Kaibab
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[4], ], xlim = c(0,625), ylim = c(0,625), col = 'white', las=1, yaxt="n", xaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
#axis(2, labels=FALSE)
#axis(1, labels=FALSE)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[4], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$Forest==ForIndex[4], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[4], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
svySlopeNK <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.NK))
...
# Coco
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[1], ], xlim = c(0,625), ylim = c(0,625), col = 'white', las=1, xaxt="n", yaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[1], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$Forest==ForIndex[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
#axis(1, labels=FALSE)
axis(4, las = 1)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeCoco <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.Coco))
abline(a = 0, b = svySlopeCoco$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[1], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(10, 600, c('C. Coconino NF'), adj=c(0,0.5))
#legend('topleft', c('C'), col = c('black'), bty = 'n')

# Tonto
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[3], ], xlim = c(0,625), ylim = c(0,625), col = 'white', las=1, xaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
#axis(1, labels=FALSE)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[3], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$Forest==ForIndex[3], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeTonto <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.Tonto))
abline(a = 0, b = svySlopeTonto$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[3], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
mtext("Predicted AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
...
# Sit
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[2], ], xlim = c(0,625), ylim = c(0,625), col = 'white',  las=1, xaxt="n", yaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[2], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$Forest==ForIndex[2], ], pch = 19, cex = .75, col = 'black', bg= 'black')
#axis(1, labels=FALSE)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeSit <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.Sit))
abline(a = 0, b = svySlopeSit$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[2], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(10, 600, c('E. AS NF, Stage 1'), adj=c(0,0.5))
#legend('topleft', c('E'), col = c('black'), bty = 'n')

# SWJM
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[5], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     las=1, yaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
axis(1, labels=FALSE)
axis(4, las = 1)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$Forest==ForIndex[5], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$Forest==ForIndex[5], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeSWJM <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.SWJM))
abline(a = 0, b = svySlopeSWJM$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[5], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
mtext("Field AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(10, 600, c('F. SW Jemez Mountains'), adj=c(0,0.5))
#legend('topleft', c('F'), col = c('black'), bty = 'n')

ForIndexVal <- unique(data.val.ind$Forest)
# Sit2
plot(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ], xlim = c(0,625), ylim = c(0,625), col = 'white', ylab = '', las=1)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.val.ind$Forest==ForIndexVal[2], ], pch = 19, cex = .75, col = 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeSit2 <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.Sit2))
abline(a = 0, b = svySlopeSit2$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
mtext("Predicted AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
mtext("Field AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
...
# Sit3
plot(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ], xlim = c(0,625), ylim = c(0,625), col = 'white', las=1, yaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
axis(4, las = 1)
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
svySlopeSit3 <- summary(svyglm(MPMEstimates ~ 0 +STBIOMSha, design = data.svy.val.Sit3))
abline(a = 0, b = svySlopeSit3$coefficients[1], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
abline(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
mtext("Field AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(10, 600, c('H. AS NF, Stage 3'), adj=c(0,0.5))
#legend('topleft', c('H'), col = c('black'), bty = 'n')

#all 
plot(MPMEstimates ~ STBIOMSha, data = data.mod, xlim = c(0,625), ylim = c(0,625), col = 'white', 
     ylab = 'Predicted AGB (Mg/ha)', xlab = '', las=1,yaxt="n", xaxt="n", frame.plot = F)
...
#dev.off()
summary(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[4], ]))
summary(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[1], ]))
summary(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[3], ]))
summary(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[2], ]))
summary(lm(MPMEstimates ~ 0 +STBIOMSha, data = data.val[data.val$Forest==ForIndex[5], ]))
#########################################################################
#########################################################################
#########################################################################
#########################################################################
...
#par(mar=c(5,3,2,2)+0.1)
#.02 
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[1], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     ylab = 'Field AGB (Mg/ha)', xlab = '', las=1, xaxt="n")#, main = 'a)')
axis(1, labels=FALSE)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[1], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
...
# .03333
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[2], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     las=1, yaxt="n", xaxt="n")
#axis(2, labels=FALSE)
axis(1, labels=FALSE)
axis(4, las = 1)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[2], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[2], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[2], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
...
# .05
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[3], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     ylab = 'Field AGB (Mg/ha)', las=1, xaxt="n")
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[3], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[3], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[3], ], pch = 19, cex = .75, col = 'black', bg= 'black')
axis(1, labels=FALSE)
mtext("Field AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
...
# .06666666
plot(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[4], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     las=1, yaxt="n", xaxt="n")
#axis(2, labels=FALSE)
axis(1, labels=FALSE)
axis(4, las = 1)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[4], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[4], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[4], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
...
# 0.1
plot(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[5], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     xlab = 'Predicted AGB (Mg/ha)', ylab = 'Field AGB (Mg/ha)', las=1)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[5], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[5], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[5], ], pch = 19, cex = .75, col = 'black')
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
mtext("Field AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
...
# 0.2
plot(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[6], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     xlab = 'Predicted AGB (Mg/ha)', las=1, yaxt="n")
#axis(2, labels=FALSE)
axis(4, las = 1)
points(MPMEstimates ~ STBIOMSha, data = data.mod[data.mod$PlotSizeha==PlotIndex[6], ], pch = 19, cex = .75, col = 'gray')
points(MPMEstimates ~ STBIOMSha, data = data.val[data.val$PlotSizeha==PlotIndex[6], ], pch = 19, cex = .75, col = 'black', bg= 'black')
points(MPMEstimates ~ STBIOMSha, data = data.val.ind[data.val.ind$PlotSizeha==PlotIndex[6], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
mtext("Predicted AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
