...
legend('bottomright', c('model construction','validation', 'trendline', 'SE trendline', '1:1'), 
       col = c('gray', 'black', trendCol,SECol, OneOneCol), 
       pch = c(19, 19, NA, NA, NA),  pt.bg = c('black', 'gray'), bty = 'n', 
       lty = c(NA, NA, trendlty, 1, OneOnelty), lwd = c(NA, NA, trendlwd, 1, OneOnelwd), 
       cex = 1.1)
