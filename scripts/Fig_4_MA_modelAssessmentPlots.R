...
#all 
plot(testmamod, 'MA', main = '', xlim = c(0,635), ylim = c(0,635), pch = 19, xlab = '', ylab = '', lwd = 2, las = 1)
...
plot(testmaval, 'MA', main = '', xlim = c(0,635), ylim = c(0,635), pch = 19, xlab = ' ', ylab = ' ', las = 1, yaxt="n")
mtext("Predicted AGB (Mg/ha)", 1, outer=FALSE, line=2)
axis(2, labels=FALSE)
...
text(labelstartR, labelendR, c('MA Reg.: Field = 1.2 * Pred - 25.24'), adj=c(0,0.5))
...
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
#abline(lm(STBIOMSha ~ 0 + MPMEstimates, data = data.val), col = 'purple', lwd = trendlwd, lty = trendlwd)

abline(testma, "MA", col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)

test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlope <- summary(svyglm(STBIOMSha ~ MPMEstimates, design = data.svy.val.all))
...
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[4], ]))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[4], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
...
axis(4, las = 1)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[1], ]))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[1], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
...
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[3], ]))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[3], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
...
#axis(1, labels=FALSE)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[2], ]))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[2], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
...
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
test<-summary(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[5], ]))
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val[data.val$Forest==ForIndex[5], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
...
abline(lm(STBIOMSha ~ MPMEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ]), col = trendCol, lwd = trendlwd, lty = trendlwd)
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
