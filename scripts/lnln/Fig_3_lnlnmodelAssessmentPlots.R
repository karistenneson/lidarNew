...
#############################
#all 
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod, xlim = c(0,755), ylim = c(0,755), col = 'white', las=1, xaxt="n")
...
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod, pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val, pch = 19, cex = .75, col = 'black', bg= 'black')
...
svySlope <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.all))
abline(a = svySlope$coefficients[1], b = svySlope$coefficients[2], col = trendColPop, lwd = trendlwdPop, lty = trendlwdPop)
mtext("Field AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(labelstart, labelend, c('A. All Model Const.'), adj=c(0,0.5))

#############################
# Kaibab
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[4], ], xlim = c(0,755), ylim = c(0,755), col = 'white', las=1, yaxt="n", xaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[4], ], pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[4], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeNK <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.NK))
...
#############################
# Coco
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[1], ], xlim = c(0,755), ylim = c(0,755), col = 'white', las=1, xaxt="n", yaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[1], ], pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
axis(4, las = 1)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
svySlopeCoco <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.Coco))
...
#############################
# Tonto
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[3], ], xlim = c(0,755), ylim = c(0,755), col = 'white', las=1, xaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
#axis(1, labels=FALSE)
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[3], ], pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[3], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeTonto <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.Tonto))
...
############################
## Sit
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[2], ], xlim = c(0,755), ylim = c(0,755), col = 'white',  las=1, xaxt="n", yaxt="n")
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[2], ], pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[2], ], pch = 19, cex = .75, col = 'black', bg= 'black')
#axis(1, labels=FALSE)
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeSit <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.Sit))
...
#############################
## SWJM
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[5], ], xlim = c(0,755), ylim = c(0,755), col = 'white', 
     las=1, yaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
axis(1, labels=FALSE)
axis(4, las = 1)
points(STBIOMSha ~ MPMlnlnEstimates, data = data.mod[data.mod$Forest==ForIndex[5], ], pch = 19, cex = .75, col = 'gray')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[5], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeSWJM <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.SWJM))
...
#############################
## Sit2
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ], xlim = c(0,755), ylim = c(0,755), col = 'white', ylab = '', las=1)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ], pch = 19, cex = .75, col = 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",'+',signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeSit2 <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.Sit2))
...
#############################
## Sit3
plot(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ], xlim = c(0,755), ylim = c(0,755), col = 'white', las=1, yaxt="n")
#axis(2, labels=FALSE)
abline(h = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
abline(v = seq(from = startSeq, to =FinSeq, by = plotInt), col = 'light grey')
axis(4, las = 1)
points(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ], pch = 19, cex = .75, col = 'black', bg= 'black')
abline(a=0, b=1, col = OneOneCol, lwd = OneOnelwd, lty = OneOnelty)
...
text(labelstartR, labelendR, paste("Field =",signif(test$coefficients[2],3),"* Pred.",signif(test$coefficients[1],3)), adj=c(0,0.5))
svySlopeSit3 <- summary(svyglm(STBIOMSha ~ MPMlnlnEstimates, design = data.svy.val.Sit3))
...
legend('bottomright', c('model construction','validation', 'trendline', '95% CI', '1:1'), 
...
#dev.off()
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[4], ]))
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[1], ]))
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[3], ]))
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[2], ]))
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[5], ]))

summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[1], ]))
summary(lm(STBIOMSha ~ MPMlnlnEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ]))
#########################################################################
summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[4], ]))
summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[1], ]))
summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[3], ]))
summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[2], ]))
summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[5], ]))

test<-summary(lm(STBIOMSha ~ 0 + MPMlnlnEstimates, data = data.val[data.val$Forest==ForIndex[5], ]))
test$coefficients
