...
testmamod<-lmodel2(STBIOMSha ~ MPMlnlnEstimates, data = data.mod, nperm=1000)
testmaval<-lmodel2(STBIOMSha ~ MPMlnlnEstimates, data = data.val, nperm=1000)
...
text(labelstartR, labelendR, c('MA Reg.: Field = 0.98 * Pred + 10.1'), adj=c(0,0.5))
...
text(labelstartR, labelendR, c('MA Reg.: Field = 1.0 * Pred + 5.88'), adj=c(0,0.5))
