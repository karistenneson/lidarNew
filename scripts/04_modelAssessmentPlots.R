...
par(mfrow=c(4, 2), mar=c(0.6, 0.6, 1.5, 0.5),
    oma=c(3.3, 3.3, 0, 0), mgp=c(2.25, 1, 0))
#par(mar=c(5,3,2,2)+0.1)
#all 
plot(STBIOMSha ~ MPMEstimates, data = data.mod, xlim = c(0,625), ylim = c(0,625), col = 'white', 
     ylab = 'Field-measured AGB (Mg/ha)', xlab = '', las=1, xaxt="n")#, main = 'a)')
axis(1, labels=FALSE)
...
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(c(600), c('A.'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(c(600), c('B.'), col = c('black'), bty = 'n')
...
plot(STBIOMSha ~ MPMEstimates, data = data.mod[data.mod$Forest==ForIndex[1], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     ylab = 'Field-measured AGB (Mg/ha)', las=1, xaxt="n")
...
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(c(600), c('C.'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(c(600), c('D.'), col = c('black'), bty = 'n')
...
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(c(600), c('E.'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(c(600), c('F.'), col = c('black'), bty = 'n')
...
plot(STBIOMSha ~ MPMEstimates, data = data.val.ind[data.val.ind$Forest==ForIndexVal[2], ], xlim = c(0,625), ylim = c(0,625), col = 'white', 
     xlab = 'Predicted AGB (Mg/ha)', ylab = 'Field-measured AGB (Mg/ha)', las=1)
...
text(c(600), c('G.'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
mtext("Predicted AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(c(600), c('H.'), col = c('black'), bty = 'n')
...
dev.new(width=7, height=16)
#par(mfrow=c(4, 2), mar=c(4.1, 2.1, 1.5, 0.5), oma=c(0, 2, 0, 0), mgp=c(2.25, 1, 0))
par(mfrow=c(3, 2), mar=c(0.6, 0.6, 1.5, 0.5),
    oma=c(3.3, 3.3, 0, 0), mgp=c(2.25, 1, 0))
#par(mar=c(5,3,2,2)+0.1)
#.02 
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(90, 600, paste('A. plot size =', PlotIndex[1], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[1]), col = c('black'), bty = 'n')
#legend('topleft', c('A'), col = c('black'), bty = 'n')
legend('bottomright', c('model construction','validation'), col = c('gray', 'black'), pch = c(19, 19),        pt.bg = c('black', 'gray'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(90, 600, paste('B. plot size =', PlotIndex[2], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[2]), col = c('black'), bty = 'n')
#legend('topleft', c('B'), col = c('black'), bty = 'n')
...
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(90, 600, paste('C. plot size =', PlotIndex[3], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[3]), col = c('black'), bty = 'n')
#legend('topleft', c('C'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
text(90, 600, paste('D. plot size =', PlotIndex[4], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[4]), col = c('black'), bty = 'n')
#legend('topleft', c('D'), col = c('black'), bty = 'n')
...
mtext("Field-measured AGB (Mg/ha)", 2, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
mtext("Predicted AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(90, 600, paste('E. plot size =', PlotIndex[5], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[5]), col = c('black'), bty = 'n')
#legend('topleft', c('E'), col = c('black'), bty = 'n')
...
abline(a=0, b=1, col = 'red', lwd = 2, lty = 5)
mtext("Predicted AGB (Mg/ha)", 1, outer=FALSE, line=2.75, xpd=NA, cex = 0.75)
text(90, 600, paste('F. plot size =', PlotIndex[6], 'ha'), col = c('black'), bty = 'n')
text(90, 550, paste('n =', lengthVec[6]), col = c('black'), bty = 'n')
#legend('topleft', c('F'), col = c('black'), bty = 'n')
