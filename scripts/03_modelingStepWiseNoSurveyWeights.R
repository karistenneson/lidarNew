...
########################################################
## BMA log
data.mod$lnBMAEstimates <- predict(object = BioMass.Mod.log, se.fit = F)
data.val$lnBMAEstimates <- predict(object = BioMass.Mod.log, newdata = data.val, se.fit = F)
data.val.ind$lnBMAEstimates <- predict(object = BioMass.Mod.log, newdata = data.val.ind, se.fit = F)
...
############################
## BMA no log
data.mod$BMAEstimates <- predict(BioMass.Mod, se.fit = F)
data.val$BMAEstimates <- predict(BioMass.Mod, newdata = data.val, se.fit = F)
data.val.ind$BMAEstimates <- predict(BioMass.Mod, newdata = data.val.ind, se.fit = F)
